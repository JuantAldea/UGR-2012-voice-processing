[s ~] = leemuestras('./8kfil/aage3201.8f', 0);
...
%      pause;
%  end
hist(frecuencias_pitch_fragmentos(frecuencias_pitch_fragmentos > 0));
pitch = mode(frecuencias_pitch_fragmentos(frecuencias_pitch_fragmentos > 0));
filter